...
Formato:
```
https://api.devlake.greencodesoftware.com/api/plugins/webhook/connections/<conn-id>/deployments
```
...
curl -u <basic-user>:<basic-pass> \
  https://api.devlake.greencodesoftware.com/api/cicd_deployment_commits \
